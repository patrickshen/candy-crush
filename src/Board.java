...
public class Board extends JPanel
{
	...
	// Grid colours
	private static final Color GRID_COLOR_A = Color.BLACK;
	private static final Color GRID_COLOR_B = Color.BLACK;
	//set default candy type
	private static final ImageIcon DEFAULT_CANDY = new ImageIcon("blue.gif");
	// Preset images for pieces
	private static final ImageIcon[] CANDIES = new ImageIcon[6];     
	// String used to indicate each colour
	private static final String[] CANDY_NAMES = {"blue", "green","orange","purple","red","bomb"};
	// Array to store icons on board
	...
	public Board (int rows, int cols)
	{
		...
		//store candy types into array
		CANDIES [0] = new ImageIcon("red.png");
		CANDIES [1] = new ImageIcon("blue.png");
		CANDIES [2] = new ImageIcon("green.png");
		CANDIES [3] = new ImageIcon("purple.png");
		CANDIES [4] = new ImageIcon("orange.png");
		CANDIES [5] = new ImageIcon("bomb.png");
	...
	/**
	 * Convert a String to the corresponding Candy 
	 */
	private ImageIcon convertImageIcon( String theCandy )
	{
		for( int i=0; i<CANDY_NAMES.length; i++ )
		{
			if( CANDY_NAMES[i].equalsIgnoreCase( theCandy ) )
				return CANDIES[i];
		}
		return DEFAULT_CANDY;
	}
	...
	/** This method will save a candy in a specific 
	 * spot.  
	 */
	public void putCandy(String theCandy, int row, int col)
	{
		this.grid[col][row] = this.convertImageIcon( theCandy );
		this.repaint();
	}

	/** Remove a candy from the gameboard.
	 */
	public void removeCandy(int row, int col)
	{
